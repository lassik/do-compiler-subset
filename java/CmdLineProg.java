...
public class CmdLineProg {
    ...
    public interface Runnable { void run(String srcPath, String dstPath) throws Exception; }
    private String progname, srcExt, dstExt; private Runnable runnable;

    private void dieSaying(String s) { System.err.println(s); System.exit(1); }

    private void usage() { dieSaying("usage: " + progname + " sourcefile"); }
    ...
    private void runWithArg(String s) throws Exception {
        ...
        } catch(Exception e) { dieSaying(progname + ": error: " + e + " " + e.getMessage()); }
    }
